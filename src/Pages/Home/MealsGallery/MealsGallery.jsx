  ...
  return (
    <div className="pb-16 bg-fixed">
      <div className="mt-6 mb-7">
        <h1 className="pt-5 pb-0 text-3xl font-bold text-center md:text-5xl">
          Our Meals Gallery
        </h1>
      </div>
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
        <div className="h-64 col-span-2 overflow-hidden rounded-md">
          <div
        ...
        <div className="hidden overflow-hidden rounded-md sm:h-full sm:row-span-2 sm:block">
          <div
            className="h-full rounded-md w-full bg-cover bg-no-repeat bg-center hover:scale-110 hover:rotate-2 duration-[2s] "
            style={{
        ...
        <div className="h-64 col-span-2 overflow-hidden rounded-md sm:hidden">
          <div
            className="h-full rounded-md w-full bg-cover bg-no-repeat bg-center hover:scale-110 hover:rotate-2 duration-[2s] "
            style={{
        ...
        <div className="h-64 overflow-hidden rounded-md sm:col-span-2">
          <div
            className="h-full rounded-md w-full bg-cover bg-no-repeat bg-center hover:scale-110 hover:rotate-2 duration-[2s] "
            style={{
        ...
        <div className="hidden col-span-1 overflow-hidden rounded-md sm:h-64 sm:block">
          <div
            className="h-full rounded-md w-full bg-cover bg-no-repeat bg-center hover:scale-110 hover:rotate-2 duration-[2s] "
            style={{
